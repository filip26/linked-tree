...
* and What if we simplify JSON-LD context definitions by reducing their capabilities and expressivity to simple mappings? This approach could enable greater analytics and facilitate comparisons to identify differences in definitions and changes in meaning.
